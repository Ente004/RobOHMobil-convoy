...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, TOF_R_EN_Pin|TOF_L_EN_Pin|RGB_Rot_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, RGB_Blau_Pin|RGB_Gelb_Pin|LD2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : TOF_R_EN_Pin TOF_L_EN_Pin RGB_Rot_Pin */
  GPIO_InitStruct.Pin = TOF_R_EN_Pin|TOF_L_EN_Pin|RGB_Rot_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : TOF_L_Pin TOF_R_Pin IR_Sensor_R_Pin IR_Sensor_L_Pin */
  GPIO_InitStruct.Pin = TOF_L_Pin|TOF_R_Pin|IR_Sensor_R_Pin|IR_Sensor_L_Pin;
